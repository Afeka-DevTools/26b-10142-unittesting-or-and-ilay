...
**AI:**
בטח. כשאתה בודק מספרים ראשוניים, אתה צריך לוודא שמספרים כמו 2 ו-17 מחזירים אמת, אבל חשוב מאוד לבדוק גם מקרי קצה כמו מספרים שליליים, 0 ו-1 שאמורים להחזיר שקר. הנה דוגמה לטסט כזה באמצעות פונקציות Assert של JUnit:
